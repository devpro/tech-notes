...
> Extensions allow users, developers, partners, and customers to extend and enhance the Rancher UI.
> In addition, users can make changes and create enhancements to their UI functionality independent of Rancher releases.
